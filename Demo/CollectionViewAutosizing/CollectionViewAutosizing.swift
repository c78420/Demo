//
//  CollectionViewAutosizing.swift
//  Demo
//
//  Created by Tony Huang (黃崇漢) on 2018/6/1.
//  Copyright © 2018年 Tony Huang (黃崇漢). All rights reserved.
//

import UIKit

class CollectionViewAutosizing: UIViewController, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib.init(nibName: "AutosizingCell", bundle: nil), forCellWithReuseIdentifier: "AutosizingCell")
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.label.text = randomTexts[indexPath.row]
        return cell
    }
}
