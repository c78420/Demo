...
class Stopwatch: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let arcPath = UIBezierPath(arcCenter: CGPoint(x: stopwatchContainerView.frame.origin.x +
                                                      (stopwatchContainerView.frame.width / 2) - 24,
                                                      y: stopwatchContainerView.frame.origin.y - (stopwatchContainerView.frame.height / 2)),
    ...
    @IBAction func stopwatchControlPressed(_ sender: UIButton) {
