...
class GesturePassword: UIViewController {
...
extension GesturePassword: UICollectionViewDataSource {
...
extension GesturePassword: UICollectionViewDelegate {
    
}

extension GesturePassword: UICollectionViewDelegateFlowLayout {
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width = collectionView.bounds.width / CGFloat(row * 2 - 1) - borderWidth * 2
...
extension GesturePassword: GestureCollectionViewDelegate {
