...
class CoreBluetooth: UIViewController {
...
extension CoreBluetooth: CBCentralManagerDelegate {
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
        ...
        case .poweredOn:
            ...
            // centralManager?.scanForPeripherals(withServices: nil) can scan all
...
extension CoreBluetooth: CBPeripheralDelegate {
